        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="html/crypto/index.html" class="logo-link">
                    <img class="logo-light logo-img" src="{{ asset('admin_assets/images/logo.png')}}" srcset="{{ asset('admin_assets/images/logo2x.png')}}"  alt="logo">
                    <img class="logo-dark logo-img" src="{{ asset('admin_assets/images/logo-dark.png')}}" srcset="{{ asset('admin_assets/images/logo-dark2x.png')}}" alt="logo-dark">
